<?php
    ...
    if(isset($_POST['order_btn'])) {
        ...
        $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE name = '$name'
        AND number = '$number' AND email = '$email' AND method = '$method' AND address = 
        '$address' AND total_products = '$total_products' AND total_price = '$cart_total'") 
        or die("Query Failed");
...
<body>
    ...
    <section class="display-order">
        ...
        ?>
        <p> <?php echo $fetch_cart['name']; ?> <span>(<?php echo '$' . $fetch_cart['price'] . '/-'
