        ...
        <div class="box-container">
            ...
            <div class="box">
                <?php
                    ...
                    `orders` WHERE payment_status = 'pending'") or die("Query Failed");
            ...
            <div class="box">
                <?php
                    ...
                    `orders` WHERE payment_status = 'completed'") or die("Query Failed");
            ...
            <div class="box">
                <?php
                    $select_admin = mysqli_query($conn, "SELECT * FROM `users`
