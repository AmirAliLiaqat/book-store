<?php
    ...
    if(isset($_GET['delete'])) {
        ...
        $delete_image_query = mysqli_query($conn, "SELECT image FROM `products`
    ...
    if(isset($_POST['update_product'])) {
        ...
        mysqli_query($conn, "UPDATE `products` SET `name`='$update_name',
        `price`='$update_price' WHERE id = '$update_p_id'") or die("Query Failed");

        $update_image = $_FILES['update_imge']['name'];
        $update_image_tmp_name = $_FILES['update_imge']['tmp_name'];
        $update_image_size = $_FILES['update_imge']['size'];
...
<body>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <div class="box">
                ...
                class="delete-btn" onclick="return confirm('are you sure to delete this product?')">delete</a>
            </div><!--box-->
            <?php
                    }
                } else{
    ...
    <section class="edit-product-form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" class="box" name="update_name" value="<?php echo $fetch_update['name']; ?>" 
            required placeholder="enter product name">
            <input type="number" class="box" name="update_price" value="<?php echo $fetch_update['price']; ?>" min="0"
